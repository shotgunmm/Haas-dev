...
class es_cls_widget
{
	public static function load_subscription($arr)
	{
		...
		$es = $es . '<div class="es_textbox">';
			$es = $es . '<input class="es_textbox_class" name="es_txt_email_pg" id="es_txt_email_pg" onkeypress="if(event.keyCode==13) es_submit_pages('.$url.')" value="" maxlength="225" type="text" placeholder="Email Address">';
		$es = $es . '</div>';
