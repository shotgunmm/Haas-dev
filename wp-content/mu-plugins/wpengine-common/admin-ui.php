...
if ( isset( $_POST['wpe-news-feed-display-options'] )) {
    ...
    $error = "";
    $plugin->set_wpengine_news_feed_enabled( $_POST['wpe-news-feed-display-enable'] );
    if ( empty( $error ) ) {
        $message = __( "Settings have been successfully updated", PWP_NAME );
    }
}
...
<?php
    ...
    $wpe_dify_enabled = $plugin->is_wpengine_news_feed_enabled();
    if($wpe_dify_enabled) {
?>
...
<? } ?>
    ...
    <? } ?>
        ...
        <form method="post" name="wpe-news-feed-display-options" action="<?php echo esc_url( $form_url ); ?>">
            ...
            <table class="form-table">
                <tr valign="top">
                <th scope="row"><label for="wpe-news-feed-display-enable">"WP Engine has your back" News Feed</label></th>
                    <td>
                        <select name="wpe-news-feed-display-enable">
                        ...
                        <div class="description comment">
                            Display the "WP Engine has your back" news feed in the WP Engine Plugin and on the Word Press Dashboard?
                        </div>
                    </td>
                </tr>
                <tr class="wpe-admin-display-options-save">
