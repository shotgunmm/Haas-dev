...
<section id="product" data-speed="4" data-type="background" data-identity="product">
	<div class="container flicker-fix">
						...
						<div class="product-list">
							<ul>
								<? foreach( get_terms( 'products', array( 'parent' => $product_type->term_id, 'orderby' => 'id' ) ) as $term ) : ?>
									...
									<? foreach( get_posts( array( 'post_type' => 'product', 'tax_query' => array( array( 'taxonomy' => 'products', 'field' => 'term_id', 'terms' => $term->term_id ) ), 'orderby' => 'menu_order', 'order' => 'ASC' ) ) as $product ) : ?>
		...
		<div class="row product-box flicker-fix" id="product-div">
					...
					<? foreach( array( 'product-classic' => $products->classic, 'product-advance' => $products->advanced ) as $box => $product_type ) : ?>
						<div class="col-md-6">
							<div class="pro-box" id="<?= $box ?>">
								...
								<div class="pro-text">
									<p><?= $product_type->description ?><br /><br /></p>
									<a href="javascript:void(0);" class="readmore-green <?= $box ?>">MORE INFORMATION</a>
								</div>
							</div>
						</div>
					<? endforeach ?>
