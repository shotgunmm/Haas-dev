...
<head>
	...
	<!--<meta name="google-site-verification" content="QE8A9qG4uVA3OmPi52eTXjSzfULYGktNJ_bPiytPMl8" />-->
	...
	<title><?= haas_title() ?></title>
		<!--[if lte IE 9]>
    		...
    		<link href="<?= get_template_directory_uri() ?>/library/stylesheets/library-style.css" rel="stylesheet">
    		<link href="<?= get_template_directory_uri() ?>/library/stylesheets/jquery.bxslider.css" rel="stylesheet">

			<script>var logged_in = <?= is_user_logged_in() ? '1' : '0' ?>;</script>
    		...
    		<script src="<?= get_template_directory_uri() ?>/library/javascripts/home.js?v=<?= time() ?>"></script>
				...
				<div class="container">
					<div class="top-info">
						<ul>
							...
							<li>|</li>
							<li><a href="<?= site_url() ?>/library" class="page-scroll">Resource Library</a> </li>
							<li>|</li>
