<? /* Template Name: Library Taxonomy  */ ?>

<?
$term = get_term_by('slug', get_query_var('library_cat'), 'library_cat' );
	// MAIN
$main_args = array(
	'post_type' => 'library',
	'posts_per_page' => 4
...
<section id="library-pg" data-speed="4" data-type="background">
	<div class="container">
		<div class="row">
						...
						<div class="event-sub-container">
							...
							<div class="event-container">
								<div class="col-md-2 image">
									<div class="icon-posted">
										...
										<?php //if(has_post_thumbnail()){
												$img = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),true);?>
								...
								<div class="col-md-10 title">
									...
									<span class="posted"><?= get_the_author() ?></span>									
								</div>
